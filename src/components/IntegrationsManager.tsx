...
/**
 * The account's source connections (Sentry / ClickUp). Scoped to the active
 * account server-side, so all calls here operate on the current workspace.
 * Rendered as a tab inside the unified "Cuenta" page.
 */
    ...
    <div>
      ...
      >
        <p className="muted" style={{ fontSize: 13, margin: 0 }}>
          Conexiones de origen (pull) que generan tareas en esta cuenta.
        </p>
      ...
      {items.length === 0 ? (
        ...
        >
          ...
          <div className="muted" style={{ maxWidth: 380 }}>
            Crea una conexión a Sentry o ClickUp para empezar a recibir tareas en
            esta cuenta.
          </div>
        </div>
      ) : (
